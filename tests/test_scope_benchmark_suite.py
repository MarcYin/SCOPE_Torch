...
def test_discover_default_cases_falls_back_to_checked_in_fixture_dir(tmp_path):
    module = _load_suite_module()
    fixture = tmp_path / "tests" / "data" / "scope_case_001.mat"
    fixture.parent.mkdir(parents=True, exist_ok=True)
    fixture.write_bytes(b"fixture")

    assert module._discover_default_cases(tmp_path) == [1]
